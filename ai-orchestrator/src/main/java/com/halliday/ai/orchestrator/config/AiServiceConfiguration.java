...
public class AiServiceConfiguration {
    ...
    @Bean
    public StreamingSpeechToTextClient streamingSpeechToTextClient(SherpaSttProperties properties, ObjectMapper mapper) {
        return new SherpaStreamingSpeechToTextClient(properties, mapper);
    }
